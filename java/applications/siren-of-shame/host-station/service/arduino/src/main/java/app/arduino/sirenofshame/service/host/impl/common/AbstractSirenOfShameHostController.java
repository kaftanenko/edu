...
public abstract class AbstractSirenOfShameHostController implements SirenOfShameHostController {
	...
	protected void notifyEventsListenersAboutStateChange(final ESirenOfShameAlarmLevel from, final ESirenOfShameAlarmLevel to) {
