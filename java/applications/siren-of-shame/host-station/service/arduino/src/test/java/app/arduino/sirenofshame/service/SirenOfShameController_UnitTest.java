package app.arduino.sirenofshame.service;
...
import app.arduino.sirenofshame.service.host.impl.dummy.DummySirenOfShameHostController;

public class SirenOfShameController_UnitTest {

	// ... properties

	private SirenOfShameHostController serviceUnderTest;

	private SirenOfShameHostControllerEventsListener eventsListenerUnderTest;
	...
	public void setUp() {
		...
		serviceUnderTest = new DummySirenOfShameHostController();
		eventsListenerUnderTest = Mockito.mock(SirenOfShameHostControllerEventsListener.class);
	}
	...
	private static void verify_ServiceState_Is(final SirenOfShameHostController service,
