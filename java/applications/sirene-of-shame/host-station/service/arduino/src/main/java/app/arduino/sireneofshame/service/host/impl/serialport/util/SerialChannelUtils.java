package app.arduino.sireneofshame.service.host.impl.serialport.util;
...
public class SerialChannelUtils {
	...
	private static final Logger LOG = SireneOfShameHostFactory.getSerialPortChannelLogger();
