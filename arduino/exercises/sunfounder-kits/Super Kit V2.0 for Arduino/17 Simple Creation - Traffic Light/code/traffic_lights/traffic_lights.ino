...
const int clkPin= 2;  //the clk of the 74HC595 attach to pin 2
const int dtPin= 3;   //the dt of the 74HC595 attach to pin 3
const int swPin= 6; // the sw of the 74HC595 attach to pin 6
